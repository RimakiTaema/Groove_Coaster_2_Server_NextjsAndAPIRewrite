...
Rewritten With Framework
`Next.js` and API System `Fastify`

(I'm Bad at Chinese So translation can put here),
...
> Stability Still Not Guaranteed To be production use and Full On Hosting <br>
> Your own Risk is Applied Uppon Using It

> [!IMPORTANT]
> Due to my new to nextjs or API things an code can be messy or generated by ai <br>
> I'll try my best to write as good as i could
